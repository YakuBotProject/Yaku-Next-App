...
export default function DashboardClient({ 
  ...
  console.log("FRONTEND RECEIVED DEVICES:", JSON.stringify(cultivos.map(c => ({ crop: c.nombreCultivo, devs: c.dispositivos }))));
  ...
  if (cultivos.length === 0) {
    return (
      <Flex direction="column" align="center" justify="center" p="6" style={{ minHeight: '60vh', opacity: isPending ? 0.6 : 1 }}>
        <Card size="3" style={{ background: '#111827', borderColor: '#1f2937', borderRadius: '16px', maxWidth: '500px', textAlign: 'center' }}>
          <Flex direction="column" gap="4" align="center" p="4">
            <Text size="8" style={{ filter: 'drop-shadow(0 0 10px rgba(52, 211, 153, 0.2))' }}>🌱</Text>
            <Box>
              <Text size="4" weight="bold" style={{ color: 'white' }} as="div" mb="2">
                No tienes cultivos registrados
              </Text>
              <Text size="2" color="gray">
                Comienza registrando tu primer cultivo para monitorear sus condiciones de humedad, temperatura, y automatizar su riego inteligente.
              </Text>
            </Box>
            <Button size="3" color="green" onClick={() => setIsOpenRegisterCrop(true)} style={{ cursor: 'pointer' }}>
      ...
      <Flex direction="column" gap="5">
        ...
        <Flex direction={{ initial: 'column', lg: 'row' }} gap="4">
          ...
          <Box style={{ flex: 1, minWidth: 0 }}>
            <ResumenDiaCard resumen={cultivoActivo.resumenDia} sensores={cultivoActivo.sensores} />
          </Box>
        </Flex>
...
const ConsumoChartCard = ({ data, limite }: { data: ConsumoData[], limite: number | null }) => {
  return (
    <Card size="3" style={{ background: '#111827', borderColor: '#1f2937', borderRadius: '16px', height: '100%' }}>
      ...
      <Box style={{ width: '100%', height: '170px', marginTop: '10px' }}>
        <ResponsiveContainer width="100%" height="100%" minWidth={0}>
...
const ResumenDiaCard = ({ resumen, sensores }: { resumen: ResumenDiaData, sensores: any }) => {
  let salud = 100;
  ...
  return (
    <Card size="3" style={{ background: '#111827', borderColor: '#1f2937', borderRadius: '16px', height: '100%' }}>
      ...
      <Flex direction="column" align="center" mb="2" style={{ position: 'relative', height: '100px' }}>
